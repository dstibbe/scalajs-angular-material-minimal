...
trait BottomSheetOptions extends js.Object {
  ...
  /**
   * The url of an html template file that will be used as the content of the bottom sheet. Restrictions: the template must have an outer md-bottom-sheet element.
   */
   ...
   */
  var controller: js.Array[Any] = js.native
  ...
  /**
   * Similar to locals, except it takes promises as values and the bottom sheet will not open until the promises resolve.
   */
